                ...
                {doubled.map((card, i) => (
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-5">
                            <p className="text-[10px] font-display font-bold text-amber-500/80 uppercase tracking-[0.25em] mb-2">
                                {card.label}
                            </p>
...
export default function SharedVoid() {
    return (
        <section className="py-20 md:py-28 bg-space-deep relative overflow-hidden">
            {/* Ambient glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] rounded-full bg-amber-500/[0.03] blur-[120px] pointer-events-none" />
            ...
            <div className="max-w-4xl mx-auto px-6 text-center mb-14 relative z-10">
                <motion.p
                    ...
                    viewport={{ once: true }}
                    className="text-xs font-display font-bold text-amber-500 uppercase tracking-[0.3em] mb-4"
                >
                    Voci nel vuoto
                </motion.p>
                <motion.h2
            ...
            >
                ...
                <p className="text-sm text-amber-500 mt-3 font-display font-600 tracking-wide">
                    Luminel.
                </p>
            </motion.div>
        </section>
