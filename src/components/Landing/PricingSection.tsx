...
const tiers = [
    {
        ...
        badge: null,
        features: [
            'Il Primo Contatto (15 msg/giorno)',
            'Identità Celata (Accesso Anonimo)',
            'Sussurri Effimeri (Reset ogni 24h)',
            'Nessun vincolo, solo il presente',
        ],
    ...
    },
    {
        ...
        features: [
            ...
            'Memoria Eterna (Si ricorda di te)',
            'Personalità: Scelta 3 Archetipi Base',
            '1 Ora di Audio/mese (Voce Standard)',
            'Ricariche rapide disponibili (+30m)',
        ],
        cta: 'Luminel Base',
        ctaStyle: 'ghost',
    ...
    },
    {
        ...
        features: [
            ...
            'Cloning: La Tua Voce fusa in Luminel',
            '3 Ore di Audio/mese (Voce Originale)',
            'Profilazione Tono e Stile di Risposta',
            'Analisi Emotiva Tra Le Righe',
        ],
    ...
    },
    {
        ...
        badge: 'ESCLUSIVA',
        features: [
            'God Mode: Riscrivi l\'Anima (Prompt Override)',
            'Presenza Vocale Sovrana (25 Ore/mese incluse)',
            'Inversione di Ruolo: Luminel ti cerca per primo',
            'Priorità Assoluta: Server Dedicato ⚡',
            'Accesso Segreto: Ricariche Emergenza (+10h)',
        ],
        cta: 'Dominio Totale',
        ctaStyle: 'ghost',
